...
<section class="relative overflow-hidden bg-(--dark-section) pt-40 pb-16">
    ...
    <div class="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="mb-6 text-base leading-relaxed text-(--on-dark)/70 max-w-2xl mx-auto">
            ...
            <article class="group flex flex-col rounded-2xl overflow-hidden bg-[var(--bg-card)] border border-[var(--border)] shadow-sm hover:shadow-xl dark:hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:-translate-y-1 transition-all duration-300">
                ...
                <div class="relative aspect-video overflow-hidden bg-[var(--accent-dim)]">
                    ...
                    <div class="absolute top-3 left-3 flex flex-wrap gap-1.5">
                        ...
                        <span class="rounded-full bg-(--dark-section)/85 backdrop-blur-sm px-2.5 py-1 text-xs font-semibold text-white">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ lroute('category.show', [$cat->slug]) }}"
               class="group relative overflow-hidden rounded-2xl p-4 flex flex-col items-center text-center
                      ...
                      dark:hover:shadow-[0_12px_24px_rgba(0,0,0,0.4)] dark:hover:border-(--accent)"
               :style="darkMode ? {} : { backgroundColor: '{{ $bg }}' }">
                ...
                <div class="relative mb-3">
                    ...
                    <div class="relative h-11 w-11 rounded-xl bg-white/70 dark:bg-(--bg-primary)/60 flex items-center justify-center shadow-sm
                                group-hover:bg-white dark:group-hover:bg-(--bg-primary)/90 group-hover:scale-110 transition-all duration-300">
                        @if($cat->icon)
                            {!! svg($cat->icon, '', ['style' => 'width:1.25rem;height:1.25rem;color:var(--accent)'])->toHtml() !!}
                        @else
                ...
                <span class="inline-flex items-center rounded-full border border-(--accent)/30 dark:border-(--accent)
                             ...
                             dark:group-hover:bg-(--accent) dark:group-hover:text-(--on-dark) transition-all duration-300">
