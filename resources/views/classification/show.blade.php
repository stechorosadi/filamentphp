...
@section('seo')
<title>{{ $classification->name }} — {{ $siteSetting->site_title }}</title>
<meta name="description" content="Browse all articles classified as {{ $classification->name }} on {{ $siteSetting->site_title }}.">
<meta property="og:title" content="{{ $classification->name }} — {{ $siteSetting->site_title }}">
...
<section class="relative overflow-hidden bg-[#132A13] dark:bg-[#0d2010] pt-28 pb-16">
    {{-- Grid texture --}}
    ...
    <div class="absolute -bottom-10 right-1/4 h-64 w-64 rounded-full bg-[#4F772D]/25 blur-3xl pointer-events-none"></div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p class="mb-8 max-w-md text-[#4F772D] dark:text-[#90A955]">
                No published articles in <span class="font-semibold text-[#132A13] dark:text-[#ECF39E]">{{ $classification->name }}</span> yet. Check back soon.
            </p>
            <a href="{{ route('home') }}"
...
<section class="relative py-12 overflow-hidden bg-[#132A13] dark:bg-[#0d2010]">
    <div class="absolute inset-0 bg-[linear-gradient(to_right,#ffffff07_1px,transparent_1px),linear-gradient(to_bottom,#ffffff07_1px,transparent_1px)] bg-size-[48px_48px] pointer-events-none"></div>

    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">

        <div class="flex items-center gap-3 mb-7">
            <div class="flex h-8 w-8 items-center justify-center rounded-lg border border-[#4F772D]/30 bg-[#4F772D]/15">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 text-[#90A955]">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z"/>
                </svg>
            </div>
            <h2 class="text-lg font-bold text-[#ECF39E]">Other Classifications</h2>
        </div>
            ...
            <a href="{{ route('classification.show', $cls->slug) }}"
               class="group flex items-center gap-3 rounded-2xl p-3
                ...
                <div class="relative shrink-0">
                    ...
                    <div class="relative h-10 w-10 rounded-xl bg-[#2a5c2a] flex items-center justify-center group-hover:bg-[#4F772D] transition-colors duration-300">
                        @if($cls->icon)
                ...
                <div class="flex-1 min-w-0">
                    <h3 class="text-xs font-bold text-[#ECF39E] leading-tight truncate">{{ $cls->name }}</h3>
                ...
                {{-- Image thumbnail --}}
                @if($cls->image)
                <div class="w-12 h-10 shrink-0 overflow-hidden rounded-lg border border-[#4F772D]/40 group-hover:border-[#4F772D]/50 transition-colors duration-300">
