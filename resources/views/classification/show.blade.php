...
<section class="relative overflow-hidden bg-[#132A13] dark:bg-[var(--dark-section)] pt-40 pb-16">
    ...
    <div class="absolute -bottom-10 right-1/4 h-64 w-64 rounded-full bg-[var(--accent)]/25 blur-3xl pointer-events-none"></div>
...
<section class="relative py-12 overflow-hidden bg-[#132A13] dark:bg-[var(--dark-section)]">
    <div class="absolute inset-0 bg-[linear-gradient(to_right,#ffffff07_1px,transparent_1px),linear-gradient(to_bottom,#ffffff07_1px,transparent_1px)] bg-size-[48px_48px] pointer-events-none"></div>

    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">

        <div class="flex items-center gap-3 mb-7">
            <div class="flex h-8 w-8 items-center justify-center rounded-lg border border-[#4F772D]/30 bg-[var(--accent)]/15">
            ...
            <a href="{{ route('classification.show', $cls->slug) }}"
               class="group flex items-center gap-3 rounded-2xl p-3
                ...
                <div class="relative shrink-0">
                    ...
                    <div class="relative h-10 w-10 rounded-xl bg-[#2a5c2a] flex items-center justify-center group-hover:bg-[var(--accent)] transition-colors duration-300">
                        @if($cls->icon)
