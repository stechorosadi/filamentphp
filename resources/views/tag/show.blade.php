...
@section('seo')
<title>#{{ $tag->name }} — {{ $siteSetting->site_title }}</title>
<meta name="description" content="Browse all articles tagged with {{ $tag->name }} on {{ $siteSetting->site_title }}.">
<meta property="og:title" content="#{{ $tag->name }} — {{ $siteSetting->site_title }}">
...
<section class="relative overflow-hidden bg-(--dark-section) pt-40 pb-16">
    ...
    <div class="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="mb-2 text-sm font-medium uppercase tracking-widest text-(--accent-on-dark)">{{ __('ui.tag_label') }}</p>
