...
<header
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            {{-- Logo --}}
            <a href="/" class="text-xl font-bold text-amber-500 tracking-tight">
                {{ config('app.name') }}
            </a>

            {{-- Desktop nav --}}
            <nav class="hidden md:flex items-center gap-1">
                <a href="#" class="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Profile</a>
                <a href="#" class="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Portfolio</a>
                <a href="#" class="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Blog</a>

                {{-- Divider --}}
                <div class="w-px h-5 bg-gray-200 dark:bg-gray-700 mx-2"></div>

                {{-- Dark toggle --}}
                <button @click="toggleDark()" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" aria-label="Toggle dark mode">
            ...
            <div class="flex md:hidden items-center gap-2">
                ...
                {{-- Burger / X --}}
                <button @click="mobileMenu = !mobileMenu" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" aria-label="Toggle menu">
                    {{-- Burger --}}
        ...
        <div
            ...
            class="md:hidden border-t border-gray-100 dark:border-gray-800 pb-4 pt-2">
            <nav class="flex flex-col gap-1">
                <a @click="mobileMenu = false" href="#" class="px-4 py-3 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Profile</a>
                <a @click="mobileMenu = false" href="#" class="px-4 py-3 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Portfolio</a>
                <a @click="mobileMenu = false" href="#" class="px-4 py-3 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">Blog</a>
            </nav>
        </div>
    </div>
</header>
